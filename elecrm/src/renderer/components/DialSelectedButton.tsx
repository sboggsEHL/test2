// DialSelectedButton.tsx
import React from 'react';
import Popup from './Popup';

interface DialSelectedButtonProps {
  onClick: () => void;
}
...
const DialSelectedButton: React.FC<DialSelectedButtonProps> = ({ onClick }) => {
...
export default DialSelectedButton;
